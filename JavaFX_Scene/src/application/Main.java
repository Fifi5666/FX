...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
        ...
        // SceneA 생성
        Button switchButton = new Button("B 화면으로 이동"); // Go to Scene B
        ...
        // SceneB 생성
        Button backButton = new Button("A 화면으로 이동"); // Go back to Scene A
        ...
        primaryStage.setTitle("화면 이동"); // 윈도우 타이틀 설정 Scene Switching Example
